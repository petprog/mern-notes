  ...
  const content = (
    <>
      ...
      >
        ...
        <input
          className={`p-2 rounded-2xl text-gray-900 ${validTitleClass}`}
          id="title"
          name="title"
          type="text"
          autoComplete="off"
        ...
        <textarea
          className={`p-2 rounded-2xl text-gray-900 min-h-[150px] ${validTextClass}`}
          id="text"
          name="text"
          value={text}
        ...
        <select
          id="username"
          name="username"
          className="w-fit p-1 text-gray-900"
          value={userId}
